...
<head>
  ...
  <jsp:useBean id="a" class="daos.ArticleDAO" scope="request"></jsp:useBean> 
</head>
    ...
    <header>
        <nav class="navbar navbar-dark navbar-expand-md fixed-top">
            ...
            <div class="navbar">
                ...
                <a type="button" href="https://accounts.google.com/o/oauth2/auth?scope=email profile&redirect_uri=http://localhost:8080/SWP391_LostAndFound/login-google&response_type=code
    &client_id=488844661259-4je86il1blo79so9u5up6nbl16du79fi.apps.googleusercontent.com&approval_prompt=force" class="btn text-primary btn-login">Login<i
