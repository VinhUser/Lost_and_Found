                                                    ...
                                                    <td> 
                                                        <div class="list-unstyled users-list m-0 d-flex align-items-center">
                                                            <span
                                                                ...
                                                                >
                                                                <img src="${m.picture}" alt="Avatar" class="rounded-circle" />
                                                            </span><strong>${m.memberName}</strong>
                                                        </div>
                                                    </td>
                                                    <td>${m.memberEmail}</td>
                                                    <td>${m.memberCount}</td>
                                                    <td>
                                                        <c:if test="${m.status eq 0}"><a class="badge bg-label-success me-1" href="WarningMemberServlet?uId=${m.memberID}&adminAction=unban">UNBAN</a></c:if>
                                                        <c:if test="${m.status eq 1}"><a class="badge bg-label-danger me-1" href="WarningMemberServlet?uId=${m.memberID}&adminAction=ban">BAN</a> | <a class="badge bg-label-warning me-1" href="WarningMemberServlet?uId=${dt.memberID}&adminAction=warnMember">WARNING</a></c:if>                   
                                                        </td>
                                                        <td><a href="ViewDetailMemberByAdminServlet?uId=${m.memberID}">View detail</a></td>
                                                </tr>
                                            </c:forEach>
                                            <%--</c:if>--%>
